  ...
  scenes: [
    ...
    },
    {
      ...
      narrative:
        ...
        '坂井さんから誤りを指摘された。先方に共有した情報を訂正し、次の対応を決められる状態に戻す必要がある。',
      dialogue: [
        {
    ...
    },
    {
      ...
      narrative:
        '今回の対応が一段落し、納品後の振り返りの時間になった。' +
        '西田さんは、今回の見通し違いと対応の経緯がなぜ起きたのか、次回はいつ何を確認できるのかを知りたいと言っている。',
      dialogue: [
        {
          characterId: 'nishida-client',
          text: '今回の対応は一段落しました。次に同じことが起きないよう、原因と今後の確認タイミングを共有いただけますか。',
        },
      ],
