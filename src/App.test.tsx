...
describe('application shell', () => {
  ...
  it('serves the public SPI explainer route with the required editorial structure and practice CTA', () => {
    ...
    expect(within(timingTable).getByRole('row', { name: /公開資料概略時間 約 30–40 分鐘/ })).toBeInTheDocument()
    expect(within(timingTable).getByRole('row', { name: /實際應考時間 .*請以企業通知為準/ })).toBeInTheDocument()
