...
-- Bounded check: q-large availability version equals 2147483648.
begin;
select plan(3);
...
select is((select question_version from public.practice_question_availability where content_id='practice-web-test-spi-v1' and question_id='q-large'),2147483648::bigint,'probe: q-large availability version = 2147483648');
select * from finish();
rollback;
