...
-- Boundary check: user1 count is 3 (A,B,bigint) after the bigint call.
begin;
select plan(3);
...
select is((select count(*) from public.practice_attempts where user_id='61000000-0000-0000-0000-000000000001'),3::bigint,'probe: user1 count = 3 after bigint call');
select * from finish();
rollback;
