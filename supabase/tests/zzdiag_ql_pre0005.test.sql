...
-- Precondition: no user1 ...0005 row exists before the bigint call.
begin;
select plan(3);
...
select is((select count(*) from public.practice_attempts where user_id='61000000-0000-0000-0000-000000000001' and client_attempt_id='61100000-0000-4000-8000-000000000005'),0::bigint,'probe: no ...0005 row before the bigint call');
select * from finish();
rollback;
