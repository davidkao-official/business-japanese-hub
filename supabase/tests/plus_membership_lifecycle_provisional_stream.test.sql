...
select is(public.record_plus_membership_event('source-provisional','customer-707','subscription-707-b','start-707-b30','50000000-0000-0000-0000-000000000707','plus_early_access_monthly','membership_reactivated',now() - interval '1 day',now() - interval '1 day',now() + interval '30 days'),'applied','#165 inherited barrier 707 B t30 beats inherited barrier');
