begin;
select plan(82);
-- DIAGNOSTIC: TODO-suppress ordinals 1-40 (run7a)
select todo('diagnostic: ordinals 1-40 (run7a)', 40);
...
-- DIAGNOSTIC: TODO-suppress ordinals 42-82 (run7b)
select todo('diagnostic: ordinals 42-82 (run7b)', 41);
