...
-- Boundary check: user1 count is 2 (A,B only) after the bigint call.
begin;
select plan(3);
...
select is((select count(*) from public.practice_attempts where user_id='61000000-0000-0000-0000-000000000001'),2::bigint,'probe: user1 count = 2 after bigint call');
select * from finish();
rollback;
