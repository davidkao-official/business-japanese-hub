...
select is(public.record_plus_membership_event('source-retired-admitted','customer-720','subscription-720-a','start-720-a30','50000000-0000-0000-0000-000000000720','plus_early_access_monthly','membership_started',now() - interval '10 days',now() - interval '10 days',now() + interval '90 days'),'stale','#165 retired admitted 720 A start t30 cannot resurrect before its scheduled cutoff');
