...
-- Baseline: the q-1 record call used by records A/B does not raise.
begin;
select plan(3);
...
select lives_ok($$ select public.record_practice_attempt('61000000-0000-0000-0000-000000000001','61100000-0000-4000-8000-000000000001','practice-web-test-spi-v1',repeat('a',64),'q-1',1,'spi','verbal','vocabulary-in-context','untimed-learning','{"input":"two"}'::jsonb,false,1200,'[]'::jsonb) $$, 'probe: baseline q-1 attempt executes without error');
select * from finish();
rollback;
