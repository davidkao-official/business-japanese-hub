...
select is(public.record_plus_membership_event('source-scheduled-live','customer-731','subscription-731-a','start-731-a30','50000000-0000-0000-0000-000000000731','plus_early_access_monthly','membership_started',now() - interval '1 day',now() - interval '1 day',now() + interval '90 days'),'stale','#165 scheduled-live 731 retired A start t30 is stale when state is absent');
