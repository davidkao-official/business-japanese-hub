...
select ok((select retired_at is not null from public.plus_membership_subscription where source_system='source-ties' and source_subscription_id='tie-00'), 'tie-00: terminal binding remains retired');
...
select ok((select retired_at is not null from public.plus_membership_subscription where source_system='source-ties' and source_subscription_id='tie-01'), 'tie-01: terminal binding remains retired');
...
select ok((select retired_at is not null from public.plus_membership_subscription where source_system='source-ties' and source_subscription_id='tie-02'), 'tie-02: terminal binding remains retired');
...
select ok((select retired_at is not null from public.plus_membership_subscription where source_system='source-ties' and source_subscription_id='tie-03'), 'tie-03: terminal binding remains retired');
...
select ok((select retired_at is not null from public.plus_membership_subscription where source_system='source-ties' and source_subscription_id='tie-04'), 'tie-04: terminal binding remains retired');
...
select ok((select retired_at is not null from public.plus_membership_subscription where source_system='source-ties' and source_subscription_id='tie-05'), 'tie-05: terminal binding remains retired');
...
select ok((select retired_at is not null from public.plus_membership_subscription where source_system='source-ties' and source_subscription_id='tie-06'), 'tie-06: terminal binding remains retired');
...
select ok((select retired_at is not null from public.plus_membership_subscription where source_system='source-ties' and source_subscription_id='tie-07'), 'tie-07: terminal binding remains retired');
...
select ok((select retired_at is not null from public.plus_membership_subscription where source_system='source-ties' and source_subscription_id='tie-08'), 'tie-08: terminal binding remains retired');
...
select ok((select retired_at is not null from public.plus_membership_subscription where source_system='source-ties' and source_subscription_id='tie-09'), 'tie-09: terminal binding remains retired');
...
select ok((select retired_at is not null from public.plus_membership_subscription where source_system='source-ties' and source_subscription_id='tie-10'), 'tie-10: terminal binding remains retired');
...
select ok((select retired_at is not null from public.plus_membership_subscription where source_system='source-ties' and source_subscription_id='tie-11'), 'tie-11: terminal binding remains retired');
